...
import { Home, Search, ClipboardList, History, User, Plus, Trophy, Menu, Star, Sun, Moon, LayoutDashboard, Store, LogOut, Users, UsersRound } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/rede',           label: 'Minha Rede',      icon: UsersRound    },
