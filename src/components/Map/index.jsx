...
const MOCK_EVENTS = [
  ...
  },
  {
    ...
    lat: -23.5969, lng: -46.6848, // mesmo local que o anterior (para testar agrupamento)
  },
  {
...
// ── Auto-centraliza o mapa nos marcadores existentes ──────────────────────────
...
// ── Popup com um ou vários eventos no mesmo local ─────────────────────────────
...
export function Map({ events = MOCK_EVENTS }) {
  // Agrupa eventos que compartilham o mesmo lat/lng
